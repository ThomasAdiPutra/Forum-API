...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    expect(DomainErrorTranslator.translate(new Error('DETAIL_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY')))
      .toStrictEqual(new InvariantError('tidak dapat mengambil komentar karena properti yang dibutuhkan tidak ada'));
    expect(DomainErrorTranslator.translate(new Error('DETAIL_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION')))
      .toStrictEqual(new InvariantError('tidak dapat mengambil komentar karena tipe data tidak sesuai'));
    ...
    expect(DomainErrorTranslator.translate(new Error('DETAIL_REPLY.NOT_CONTAIN_NEEDED_PROPERTY')))
      .toStrictEqual(new InvariantError('tidak dapat mengambil balasan karena properti yang dibutuhkan tidak ada'));
    expect(DomainErrorTranslator.translate(new Error('DETAIL_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION')))
      .toStrictEqual(new InvariantError('tidak dapat mengambil balasan karena tipe data tidak sesuai'));
